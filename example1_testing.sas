...
%let interv1 = intno=1 ,  nintvar=1,
    intlabel='All subjects exercise at least 30  all intervals',
    intvar1 = act, inttype1 = 2, intmin1=30, intpr1=1, inttimes1 = 0 1 2 3 4 5 ;



%let interv2 = intno=2 ,  nintvar=1,
    intlabel='All subjects exercise at least 30 except at 2',
    intvar1 = act, inttype1 = 2, intmin1=30, intpr1=1, inttimes1 = 0 1  3 4 5 ;
...
cov2  = act,    cov2otype  = 4, cov2ptype = skpcub, cov2skip = 2 ,

hazardratio = 0 ,
intcomp = 0 1 ,
seed= 9458, nsamples = 0, numint=2
);
